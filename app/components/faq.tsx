...
const FAQ: React.FC = () => {
    ...
    return (
        <div className="bg-gradient-to-b from-[#0C0F12] to-black pb-20 flex flex-col items-center justify-center px-4 sm:px-8">
            <h2 className='text-2xl sm:text-3xl font-bold mb-6 sm:mb-8'>FAQs</h2>
            ...
            <div className='max-w-240 mx-auto w-full'>
                ...
                <div className='bg-[#1D242D] rounded-lg h-[2px] sm:h-[3px]'></div>
