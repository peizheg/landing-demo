const Footer = () => {
    return (
        <footer className="bg-black text-white pt-8 pb-5 mx-auto px-8">
            <div className="max-w-300 mx-auto">
                {/* Contacts */}
                <div className="pb-30 pt-8 mx-4 flex justify-between">
                    <p className="text-3xl font-bold">Get started for <span className="text-transparent bg-clip-text bg-gradient-to-br from-[#6e7f42] via-[#c37842] to-[#f04e42]">free.</span></p>
                    ...
                    <div className="space-y-4 max-w-md">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="flex flex-col sm:flex-row gap-3">
                                ...
                                />
                                <button className="bg-white text-black text-lg font-bold px-5 py-3 w-44 h-11 rounded-[20px] flex items-center justify-between hover:-translate-y-0.5 hover:duration-500 hover:ease-[cubic-bezier(0.4, 0, 0.2, 1)] hover:bg-gradient-to-r from-[#58f1ff63] via-[#5f83f04f] to-[#e54bdb49]">
                                    Subscribe
                                    <img className="h-3.5" src='/arrow_right.webp' alt="arrow right" />
                                </button>
                            </div>
